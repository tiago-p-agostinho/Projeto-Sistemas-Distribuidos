...
public class Query{
  ...
  ////////////////////////////////////////////////////////
	...
	public String getEndSec(){
		   ...
		   if(endSec.equals("http://localhost:8080/LargaCaixa1/endpoint")){
		      endSec = "http://localhost:8080/LargaCaixa2/endpoint";
		   }else{
              endSec = "http://localhost:8080/LargaCaixa1/endpoint";		   
	}
	return endSec;
  }
}