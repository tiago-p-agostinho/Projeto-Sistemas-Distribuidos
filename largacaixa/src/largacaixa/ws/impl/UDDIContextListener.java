...
public class UDDIContextListener implements ServletContextListener {
	...
	private String URL1 = "http://localhost:8080/LargaCaixa1/endpoint";
	
	private String URL2 = "http://localhost:8080/LargaCaixa2/endpoint";
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent) {
        ...
        try {
            ...
            String bindingURL = "http://localhost:8080/LargaCaixa1/endpoint";  

			String Horganization = "Hello";
			String HserviceName = "hello";
			String HbindingDescription = "Information for acessing the Hello service";
			String HbindingURL = "http://localhost:8080/LargaCaixa2/Hello";
