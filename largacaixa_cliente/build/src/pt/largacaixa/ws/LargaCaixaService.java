 ...
 * 
 */
@WebServiceClient(name = "LargaCaixaService", targetNamespace = "http://ws.largacaixa.pt/", wsdlLocation = "http://localhost:8080/LargaCaixa1/endpoint?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/LargaCaixa1/endpoint?WSDL");
